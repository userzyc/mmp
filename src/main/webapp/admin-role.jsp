    ...
    <body>
		...
		<form id="form" name="" method="post">
			<div class="personalmanage">
				<label for="personalName">&nbsp;&nbsp;旧密码：</label> <input type="text"
					name="" id="Name" value="" class="personalWidth">
				<!-- 放置提示信息 -->
				<font color="red"></font>
			</div>
			<div class="personalmanage">
				<label for="personalPhone">&nbsp;&nbsp;新密码：</label> <input type="text"
					name="productName" id="Phone" value="" class="personalWidth"> <font
					color="red"></font>
			</div>
			<div class="personalmanage">
				<label for="personalEmail">确认密码：</label> <input type="text"
					name="productUnit" id="Email" value="" class="personalWidth"> <font
					color="red"></font>
			</div>
			
			<div id="personalupd" class="personalmanage">
				<input type="submit" name=""  value="保存" style="width:280px;height: 40px; background-color: gray;position: relative;left:23px;">
			</div>
		</form>
	</div>
